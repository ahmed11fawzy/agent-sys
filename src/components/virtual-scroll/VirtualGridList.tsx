...
/**
 * 1. Define the component logic independently to preserve the <T> generic
 */
const VirtualGridListInner = <T,>({
  items,
  renderItem,
  onEndReached,
  isFetchingMore,
  ...
  const defaultLoadingIndicator = (
    <div className="flex items-center justify-center p-4">
      ...
      <span className="ml-2 text-sm text-gray-500">{t("Loading more...")}</span>
    </div>
  );
...
/**
 * 2. Export the memoized version cast as the original type.
 * This ensures consumers can use <VirtualGridList<User> ... />
 */
export const VirtualGridList = memo(
  VirtualGridListInner
) as typeof VirtualGridListInner;
